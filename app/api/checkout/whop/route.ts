...
export async function POST(req: Request) {
  try {
    ...
    try {
      ...
      console.warn('[Whop Checkout API] Notice recording bid:', dbErr);
    }
    ...
    console.error('[Whop Checkout API Route Error]:', message);
    return NextResponse.json({ error: message || 'Whop checkout creation failed' }, { status: 500 });
  }
}
